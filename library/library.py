...
async def show_question(
    ...
    # Клавиатура с числовыми кнопками
    keyboard = get_test_keyboard(question.options, test_state.selected_answers)
...
async def finish_test(
    ...
    """
    Завершение теста: подсчет результатов, отображение.
